...
class MatchingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.EvaluateDriverPosition = channel.unary_unary(
                '/matching.MatchingService/EvaluateDriverPosition',
                request_serializer=matching__pb2.DriverPosition.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.RequestMatch = channel.unary_unary(
                '/matching.MatchingService/RequestMatch',
...
class MatchingServiceServicer(object):
    ...
    def EvaluateDriverPosition(self, request, context):
...
def add_MatchingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'EvaluateDriverPosition': grpc.unary_unary_rpc_method_handler(
                    servicer.EvaluateDriverPosition,
                    request_deserializer=matching__pb2.DriverPosition.FromString,
...
class MatchingService(object):
    ...
    @staticmethod
    def EvaluateDriverPosition(request,
            target,
            options=(),
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/matching.MatchingService/EvaluateDriverPosition',
            matching__pb2.DriverPosition.SerializeToString,
